    ...
    return (
        <div className="space-y-4 h-full flex flex-col">
            ...
            <div className="flex-1 overflow-hidden bg-transparent">
                {/* Mobile List View */}
                <div className="md:hidden h-full overflow-y-auto pb-safe">
                    <MobileCardList
                        data={filteredLogs}
                        isLoading={isLoading}
                        renderItem={(log) => (
                            <Card
                                className="mb-3 bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 shadow-sm active:scale-[0.99] transition-transform"
                            ...
                            >
                                <CardContent className="p-3">
                                    ...
                                    <div className="flex items-center gap-2 mb-1.5">
                                        <Badge variant="outline" className="text-[10px] h-5 px-1.5 font-mono text-neutral-500">
                                            {log.component}
                                        </Badge>
                                    </div>
                                    <div className="text-sm font-medium text-neutral-800 dark:text-neutral-200 line-clamp-2">
                                        {log.message}
                                    </div>
                                </CardContent>
                            </Card>
                ...
                {/* Desktop Table View */}
                <Card className="hidden md:flex flex-col h-full overflow-hidden border border-neutral-200 dark:border-neutral-800 shadow-sm bg-white dark:bg-neutral-900">
