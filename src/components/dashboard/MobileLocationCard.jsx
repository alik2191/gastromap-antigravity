...
const MobileLocationCard = memo(function MobileLocationCard({ location, savedLocation, onSave, onOpenDetail }) {
    ...
    return (
        <Link 
            to={buildLocationUrl()}
            className={`bg-white dark:bg-neutral-800 rounded-3xl overflow-hidden shadow-sm cursor-pointer block relative ${
                isNew 
        ...
        >
            ...
            <div className="p-3">
                ...
                <Button
                    ...
                    disabled={saving}
                    className={`w-full rounded-full h-8 font-medium transition-all text-[10px] px-2 active:scale-95 ${
